...
namespace RodeoBigSalesManagement.BasicSamples.Endpoints
{
    using Serenity;
    using Serenity.Data;
    ...
    public class VSGalleryQAController : ServiceEndpoint
    {
        ...
        private List<VSGalleryQAThread> LoadFromLocalCopy()
        {
            ...
            if (!System.IO.File.Exists(path))
            {
                ...
                var bytes = new WebClient().DownloadData("https://github.com/volkanceylan/RodeoBigSalesManagement/raw/master/RodeoBigSalesManagement/RodeoBigSalesManagement.Web/" + 
