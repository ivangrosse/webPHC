...
using Administration = MusicShop.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "fa-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: MusicShop.Administration.PermissionKeys.Security, icon: "icon-ban", Target = "_blank")]
