    ...
    public class DefaultDB_20141123_155100_Initial : Migration
    {
        public override void Up()
        {
            IfDatabase("SqlServer", "SqlServer2000", "SqlServerCe")
                .Execute.EmbeddedScript("Serene1.Web.Migrations.NorthwindDB.NorthwindDBScript_SqlServer.sql");

            IfDatabase("Postgres")
                .Execute.EmbeddedScript("Serene1.Web.Migrations.NorthwindDB.NorthwindDBScript_Postgres.sql");

            IfDatabase("Postgres")
                .Execute.EmbeddedScript("Serene1.Web.Migrations.NorthwindDB.NorthwindDBScript_PostgresData.sql");

            IfDatabase("MySql")
                .Execute.EmbeddedScript("Serene1.Web.Migrations.NorthwindDB.NorthwindDBScript_MySql.sql");

            IfDatabase("Oracle")
                .Execute.EmbeddedScript("Serene1.Web.Migrations.NorthwindDB.NorthwindDBScript_Oracle.sql");
            IfDatabase("Sqlite")
                .Execute.EmbeddedScript("Serene1.Web.Migrations.NorthwindDB.NorthwindDBScript_Sqlite.sql");
